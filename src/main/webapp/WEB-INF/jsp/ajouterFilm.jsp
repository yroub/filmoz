		...
		<div>
			<form:form action="ajouterValid" method="POST"
				...
				<div class="form-group">
					...
					<div class="col-xs-10">
						<form:input path="annee" placeholder="Année de sortie ..."
							cssClass="form-control" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-5">
						<form:input path="real.prenom" placeholder="Prénom ..."
							cssClass="form-control" />
				...
				<div class="form-group">
					...
					<div class="col-xs-10">
						<form:input path="duree"
							placeholder="Durée du film (format h:mm) ..."
							cssClass="form-control" />
					</div>
				</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-5">
							<input name="acteurs[${ind}].prenom"
								value="${film.acteurs[ind].prenom}" placeholder="Prénom ..."
								class="form-control" />
						</div>
						<div class="col-xs-5">
				...
				<div class="form-group">
					...
					<div class="col-xs-10">
						<form:textarea path="synopsis" rows="5"
							placeholder="Résumé et commentaires ..." cssClass="form-control" />
					</div>
				</div>
